package com.oy.u920.imageloader.imageaware;
...
public abstract class ViewAware implements ImageAware {
	...
	protected boolean mCheckActualViewSize;
	...
	public ViewAware(View view, boolean checkActualViewSize) {
		...
		this.mCheckActualViewSize = checkActualViewSize;
	}
	...
	public int getWidth() {
		...
		if (view != null) {
			...
			int width = 0;
			if (mCheckActualViewSize && params != null && params.width != ViewGroup.LayoutParams.WRAP_CONTENT) {
	...
	public int getHeight() {
		...
		if (view != null) {
			final ViewGroup.LayoutParams params = view.getLayoutParams();
			int height = 0;
			if (mCheckActualViewSize && params != null && params.height != ViewGroup.LayoutParams.WRAP_CONTENT) {
